...
public class HTML5WebViewVimeo extends WebView {
	...
	private void init(Context context) {
		...
		mBrowserFrameLayout = (FrameLayout) LayoutInflater.from(a).inflate(R.layout.layout_vimeo, null);
	...
	public HTML5WebViewVimeo(Context context) {
		super(context);
		init(context);
	}

	public HTML5WebViewVimeo(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public HTML5WebViewVimeo(Context context, AttributeSet attrs, int defStyle) {
    ...
    private class MyWebChromeClient extends WebChromeClient {
		...
		public void onShowCustomView(View view, WebChromeClient.CustomViewCallback callback)
		{
	        ...
	        HTML5WebViewVimeo.this.setVisibility(View.GONE);
	        Log.d(TAG, "HTML5WebView child count: "+HTML5WebViewVimeo.this.getChildCount());
		...
		public void onHideCustomView() {
			...
			HTML5WebViewVimeo.this.setVisibility(View.VISIBLE);
